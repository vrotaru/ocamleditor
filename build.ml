...
let targets = [
  ...
  "ocamleditor", {
    ...
    search_path          = "+ocamldoc gmisclib common icons otherwidgets oebuild v410"; (* -I *)
    ...
    external_tasks       = [];
    restrictions         = [];
    dependencies         = [14; 19; 16; 26; 22; 28];
    show                 = true;
    rc_filename          = None;
  };
  ...
  "ocamleditor-bytecode", {
    ...
    external_tasks       = [];
    restrictions         = [];
    dependencies         = [4; 10; 7; 5; 8; 9; 20; 17; 18; 25; 28];
    show                 = true;
    rc_filename          = None;
  };
  ...
  "version-4.10", {
    ...
    compilation_bytecode = true;
    compilation_native   = true;
    toplevel_modules     = "v410/binannot.ml v410/binannot_ident_scan.ml v410/binannot_type.ml";
