...
let targets = [
  ...
  "ocamleditor", {
    ...
    search_path          = "+ocamldoc gmisclib common icons otherwidgets oebuild v410 v411"; (* -I *)
    required_libraries   = "process_termination odoc_info gmisclib common icons otherwidgets oebuildlib v ocamleditor_lib";
    ...
    external_tasks       = [];
    restrictions         = [];
    dependencies         = [14; 19; 16; 26; 22; 28; 29];
    show                 = true;
    rc_filename          = None;
  };
  ...
  "ocamleditor-bytecode", {
    ...
    package              = "compiler-libs.common,dynlink,lablgtk2,str,unix,xml-light";
    search_path          = "+ocamldoc gmisclib common icons otherwidgets oebuild v410 v411"; (* -I *)
    required_libraries   = "process_termination odoc_info gmisclib common icons otherwidgets v oebuildlib";
    compiler_flags       = "-w syxm -g";
    linker_flags         = "-g";
    thread               = true;
    vmthread             = false;
    ...
    external_tasks       = [];
    restrictions         = [];
    dependencies         = [4; 10; 7; 5; 8; 9; 20; 17; 18; 25; 28; 29];
    show                 = true;
    rc_filename          = None;
  };
  ...
  "ocamleditor-native", {
    ...
    external_tasks       = [];
    restrictions         = [];
    dependencies         = [14; 19; 16; 26; 28; 29];
    show                 = true;
    rc_filename          = None;
  };
  ...
  "ocamleditor-lib", {
    ...
    external_tasks       = [];
    restrictions         = [];
    dependencies         = [4; 10; 5; 8; 9; 20; 28; 29];
    show                 = true;
    rc_filename          = None;
  };
  ...
  (* 15 *)
  "version-4.10", {
    descr                = "Ocaml 4.10.x specific code";
    num                  = 15;
    id                   = 28;
    output_name          = "v";
    target_type          = Library;
    compilation_bytecode = true;
    compilation_native   = true;
    toplevel_modules     = "v410/binannot.ml v410/binannot_ident_scan.ml v410/binannot_type.ml v410/versioned_lex.ml";
    package              = "compiler-libs.common";
    search_path          = "+ocamldoc common v410"; (* -I *)
    required_libraries   = "common";
    compiler_flags       = "";
    linker_flags         = "";
    thread               = false;
    ...
    other_objects        = "";
    external_tasks       = [];
    restrictions         = ["OCAML(cmt_magic_number=Caml1999T027)"];
    dependencies         = [4];
    show                 = true;
    rc_filename          = None;
  };
  ...
  (* 16 *)
  "version-4.11", {
    descr                = "OCaml 4.11.x specific code";
    num                  = 16;
    id                   = 29;
    output_name          = "v";
    target_type          = Library;
    compilation_bytecode = false;
    compilation_native   = true;
    toplevel_modules     = "v411/binannot.ml v411/binannot_ident_scan.ml v411/binannot_type.ml v411/versioned_lex.ml";
    package              = "compiler-libs.common";
    search_path          = "+ocamldoc common v411"; (* -I *)
    required_libraries   = "common";
    compiler_flags       = "";
    linker_flags         = "";
    thread               = false;
    ...
    other_objects        = "";
    external_tasks       = [];
    restrictions         = ["OCAML(cmt_magic_number=Caml1999T028)"];
    dependencies         = [4];
    show                 = true;
    rc_filename          = None;
  };
